      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-heading text-primary-dark leading-tight">
            ...
            <div className="flex flex-wrap gap-2.5 pt-1 text-xs font-extrabold text-primary-dark">
              <span className="bg-white px-3.5 py-2 rounded-full border border-slate-200 shadow-xs flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-primary-dark fill-primary" /> 📍 Kattathurai
              </span>
              <span className="bg-white px-3.5 py-2 rounded-full border border-slate-200 shadow-xs flex items-center gap-1">
                <Truck className="w-3.5 h-3.5 text-primary-dark" /> 🚚 Free Delivery up to 3 KM
              </span>
              <span className="bg-white px-3.5 py-2 rounded-full border border-slate-200 shadow-xs flex items-center gap-1">
                <Gift className="w-3.5 h-3.5 text-primary-dark" /> 🎁 Customized Gifts Available
              </span>
            </div>
            ...
            <div className="pt-2">
              <button 
                ...
                className="btn-neon text-xs py-3 px-7 font-bold flex items-center gap-2 text-slate-900"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-md group">
              ...
              <div className="absolute bottom-3 left-3 right-3 p-3 bg-white/95 rounded-xl border border-slate-200 flex items-center justify-between text-xs">
                <div>
                  <div className="font-extrabold text-primary-dark">Main Junction Store</div>
